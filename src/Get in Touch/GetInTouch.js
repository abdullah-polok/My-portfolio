...
const GetInTouch = () => {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="3000" className=' mt-24 '>
            <div className='font-bold text-3xl achieve-title'>
                <h1>Get in Touch</h1>
            </div>

            <footer className="footer lg:p-24 md:p-24 p-6 text-center  text-neutral-content">
                <div>
                    <div className='flex '>
                        ...
                        <div className='text-left ml-4'>
                            <h1 className='text-white font-bold text-3xl '>Abdullah's Portfolio</h1>
                            <p className='text-lg'>ERBIL,IRAQ</p>
                            <a className="text-lg f6 db fw6 pv3 black-70 link dim text-white" title="Call SF" href="tel:+96407503898304">
                                +96407503898304
                            </a>
                        </div>
                    </div>
                ...
                <div>
                    <span className="footer-title text-lg mb-0">Quick Contact</span>
                    <div className="grid grid-flow-col gap-4">
                        <a class="text-lg mt-0" href="mailto:abdullahalrahman23@gmail.com">
